...
export const LocationsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {toastMessage && (
        <div
          className={`fixed top-5 right-5 z-50 p-4 rounded-2xl shadow-xl border text-xs font-bold animate-in slide-in-from-top-2 duration-200 ${toastMessage.type === 'success'
